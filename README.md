...
- Get your user id by clicking your profile in the discord client and clicking 'Copy User ID.' *This is not the same as your username*
...
- To get their discord id right click on their name and click 'Copy User ID.' *This is not the same as their username*
- To get their public key file, have them run first time setup and send you their priv_key.pem file, keep it somewhere easy to access. *Keep the title as priv_key.pem*
